...
#Region "operadores"
    ...
    ''' </summary>
    ''' <param name="v1">La lista de procesos a comprobar.</param>
    ''' <param name="v2">La lista de procesos para comparar.</param>
    ...
    ''' <returns>Devuelve true si alguna de las listas no están instanciadas o tiene distinto número de elementos con respecto a la otra lista.</returns>
    ''' <remarks>Deben ser clases instanciadas los argumentos.</remarks>
    Public Shared Operator <>(v1 As ListaProcesos, v2 As ListaProcesos) As Boolean
        Return ((v1 = v2) = False)
    End Operator
